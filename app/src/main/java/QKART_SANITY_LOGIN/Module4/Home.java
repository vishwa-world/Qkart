...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='root']/div/div/div[1]/div[2]/div/input"))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status = driver.findElementByXPath("//*[@id='root']/div/div/div[1]/div[2]/div/input").isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
        }
